...
enum {
    ...
    SDVM_SHT_RISCV_ATTRIBUTES = 0x70000003
};
...
enum {
    ...
    SDVM_R_AARCH64_ADR_PREL_PG_HI21 = 276,
    SDVM_R_AARCH64_ADD_ABS_LO12_NC = 277,
...
enum {
    ...
    SDVM_R_RISCV_BRANCH = 16,
    SDVM_R_RISCV_JAL = 17,
    SDVM_R_RISCV_CALL_PLT = 19,
    SDVM_R_RISCV_PCREL_HI20 = 23,
    SDVM_R_RISCV_PCREL_LO12_I = 24,
    SDVM_R_RISCV_PCREL_LO12_S = 25,
    SDVM_R_RISCV_HI20 = 26,
    SDVM_R_RISCV_LO12_I = 27,
    SDVM_R_RISCV_LO12_S = 28,
