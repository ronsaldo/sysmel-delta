...
class ASGNodeWithInstructionScheduling:
    def __init__(self, functionalNode, schedule) -> None:
...
class GlobalCodeMotionAlgorithm:
    ...
    def computeUserLists(self):
        ...
        def visitNode(user):
            for dataDependency in user.dataDependencies():
                if dataDependency in self.dataInstructionIndexDictionary:
                    self.dataInstructionUserLists[self.dataInstructionIndexDictionary[dataDependency]].addUser(user)
    ...
    def earlyScheduleInstructions(self):
        ...
        def visitInstruction(instructionIndex):
            ...
            for dataDependency in instruction.dataDependencies():
                if dataDependency not in self.dataInstructionIndexDictionary:
                    continue

                dependencyIndex = self.dataInstructionIndexDictionary[dataDependency]
