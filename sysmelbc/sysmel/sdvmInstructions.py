...
SdvmConstInt64ConstSection = sdvmConstantDef('SdvmConstInt64ConstSection', opcode = 0x0105, type = SdvmTypeInteger, description = '"Int64 literal encoded in const section at zero extended offset."')
