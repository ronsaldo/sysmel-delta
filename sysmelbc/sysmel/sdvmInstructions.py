...
SdvmConstInt32 = sdvmConstantDef('SdvmConstInt32', opcode = 0x0001, type = SdvmTypeInteger, description = '"Int32 constant."')
SdvmConstInt64SExt = sdvmConstantDef('SdvmConstInt64SExt', opcode = 0x0003, type = SdvmTypeInteger, description = '"Signed extended small Int64 constant."')
SdvmConstInt64ZExt = sdvmConstantDef('SdvmConstInt64ZExt', opcode = 0x0005, type = SdvmTypeInteger, description = '"Zero extended small Int64 constant."')
SdvmConstInt64ConstSection = sdvmConstantDef('SdvmConstInt64ConstSection', opcode = 0x0005, type = SdvmTypeInteger, description = '"Int64 literal encoded in const section at zero extended offset."')
SdvmConstPointerSExt = sdvmConstantDef('SdvmConstPointerSExt', opcode = 0x0001, type = SdvmTypePointer, description = '"Signed extended pointer constant"')
SdvmConstPointerZExt = sdvmConstantDef('SdvmConstPointerZExt', opcode = 0x0003, type = SdvmTypePointer, description = '"Zero extended pointer constant"')
SdvmConstPointerConstSection = sdvmConstantDef('SdvmConstPointerConstSection', opcode = 0x0005, type = SdvmTypePointer, description = '"Int64 literal encoded in const section at zero extended offset."')
SdvmConstFatPointerNull = sdvmConstantDef('SdvmConstFatPointerNull', opcode = 0x0001, type = SdvmTypeFatPointer, description = '"Null fat pointer constant"')
SdvmConstFloat32 = sdvmConstantDef('SdvmConstFloat32', opcode = 0x0001, type = SdvmTypeFloat, description = '"IEEE 754 single precision floating point constant."')
SdvmConstFloat64Small32 = sdvmConstantDef('SdvmConstFloat64Small32', opcode = 0x0003, type = SdvmTypeFloat, description = '"IEEE 754 double precision floating point constant, encoded by extending IEEE 754 single precision constant."')
SdvmConstFloat64ConstSection = sdvmConstantDef('SdvmConstFloat64ConstSection', opcode = 0x0005, type = SdvmTypeFloat, description = '"IEEE 754 double precision floating point encoded in const section at zero extended offset."')
...
SdvmInstReturnFloat = sdvmInstructionDef('SdvmInstReturnFloat', opcode = 0x7000C, type = SdvmTypeVoid, arg0Type = SdvmTypeFloatVector, arg1Type = SdvmTypeVoid, description = 'Return float vector')
