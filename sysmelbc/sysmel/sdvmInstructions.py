...
SdvmOpLogicalShiftLeft = sdvmOpcodeDef('SdvmOpLogicalShiftLeft', opcode = 0x0016, description = '"Logical shift left"')
SdvmOpLogicalShiftRight = sdvmOpcodeDef('SdvmOpLogicalShiftRight', opcode = 0x0017, description = '"Logical shift right"')
SdvmOpArithmeticShiftRight = sdvmOpcodeDef('SdvmOpArithmeticShiftRight', opcode = 0x0018, description = '"Arithmetic shift right"')
