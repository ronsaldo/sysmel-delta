...
SdvmInstFreeManual = sdvmInstructionDef('SdvmInstFreeManual', opcode = 0x3D468, type = SdvmTypePointer, arg0Type = SdvmTypeInfo, arg1Type = SdvmTypeVoid, description = 'Frees memory.')
