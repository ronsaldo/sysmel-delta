...
SdvmConstImportBoolean = sdvmConstantDef('SdvmConstImportBoolean', opcode = 0x0089, type = SdvmTypeBoolean, description = '"Import Boolean."')
SdvmConstInt8 = sdvmConstantDef('SdvmConstInt8', opcode = 0x0101, type = SdvmTypeInt8, description = '"Int8 constant."')
SdvmConstImportInt8 = sdvmConstantDef('SdvmConstImportInt8', opcode = 0x0109, type = SdvmTypeInt8, description = '"Int8 imported constant."')
SdvmConstInt16 = sdvmConstantDef('SdvmConstInt16', opcode = 0x0181, type = SdvmTypeInt16, description = '"Int16 constant."')
SdvmConstImportInt16 = sdvmConstantDef('SdvmConstImportInt16', opcode = 0x0189, type = SdvmTypeInt16, description = '"Int16 imported constant."')
SdvmConstInt32 = sdvmConstantDef('SdvmConstInt32', opcode = 0x0201, type = SdvmTypeInt32, description = '"Int32 constant."')
SdvmConstImportInt32 = sdvmConstantDef('SdvmConstImportInt32', opcode = 0x0209, type = SdvmTypeInt32, description = '"Int32 imported constant."')
...
SdvmConstImportInt64 = sdvmConstantDef('SdvmConstImportInt64', opcode = 0x0289, type = SdvmTypeInt64, description = '"Int64 imported constant."')
SdvmConstUInt8 = sdvmConstantDef('SdvmConstUInt8', opcode = 0x0301, type = SdvmTypeUInt8, description = '"Int8 constant."')
SdvmConstImportUInt8 = sdvmConstantDef('SdvmConstImportUInt8', opcode = 0x0309, type = SdvmTypeUInt8, description = '"Int8 imported constant."')
SdvmConstUInt16 = sdvmConstantDef('SdvmConstUInt16', opcode = 0x0381, type = SdvmTypeUInt16, description = '"Int16 constant."')
SdvmConstImportUInt16 = sdvmConstantDef('SdvmConstImportUInt16', opcode = 0x0389, type = SdvmTypeUInt16, description = '"Int16 imported constant."')
SdvmConstUInt32 = sdvmConstantDef('SdvmConstUInt32', opcode = 0x0401, type = SdvmTypeUInt32, description = '"Int32 constant."')
SdvmConstImportUInt32 = sdvmConstantDef('SdvmConstImportUInt32', opcode = 0x0409, type = SdvmTypeUInt32, description = '"Int32 imported constant."')
...
SdvmConstImportUInt64 = sdvmConstantDef('SdvmConstImportUInt64', opcode = 0x0489, type = SdvmTypeUInt64, description = '"Int64 imported constant."')
...
SdvmConstImportGCPointer = sdvmConstantDef('SdvmConstImportGCPointer', opcode = 0x0609, type = SdvmTypeGCPointer, description = '"GC Pointer imported constant."')
SdvmConstFloat32 = sdvmConstantDef('SdvmConstFloat32', opcode = 0x0683, type = SdvmTypeFloat32, description = '"Float32 constant."')
SdvmConstImportFloat32 = sdvmConstantDef('SdvmConstImportFloat32', opcode = 0x0689, type = SdvmTypeFloat32, description = '"Import float32."')
...
SdvmConstImportFloat64 = sdvmConstantDef('SdvmConstImportFloat64', opcode = 0x0709, type = SdvmTypeFloat64, description = '"Import float64."')
...
SdvmInstCallClosureBoolean = sdvmInstructionDef('SdvmInstCallClosureBoolean', opcode = 0x7B020C, type = SdvmTypeBoolean, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeInfo, description = 'Call boolean returning procedure')
SdvmInstCallClosureInt8 = sdvmInstructionDef('SdvmInstCallClosureInt8', opcode = 0x3040C, type = SdvmTypeInt8, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call int8 returning procedure')
SdvmInstCallClosureInt16 = sdvmInstructionDef('SdvmInstCallClosureInt16', opcode = 0x3060C, type = SdvmTypeInt16, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call int16 returning procedure')
SdvmInstCallClosureInt32 = sdvmInstructionDef('SdvmInstCallClosureInt32', opcode = 0x3080C, type = SdvmTypeInt32, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call int32 returning procedure')
SdvmInstCallClosureInt64 = sdvmInstructionDef('SdvmInstCallClosureInt64', opcode = 0x30A0C, type = SdvmTypeInt64, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call int64 returning procedure')
SdvmInstCallClosureUInt8 = sdvmInstructionDef('SdvmInstCallClosureUInt8', opcode = 0x30C0C, type = SdvmTypeUInt8, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call uint8 returning procedure')
SdvmInstCallClosureUInt16 = sdvmInstructionDef('SdvmInstCallClosureUInt16', opcode = 0x30E0C, type = SdvmTypeUInt16, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call uint16 returning procedure')
SdvmInstCallClosureUInt32 = sdvmInstructionDef('SdvmInstCallClosureUInt32', opcode = 0x3100C, type = SdvmTypeUInt32, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call uint32 returning procedure')
SdvmInstCallClosureUInt64 = sdvmInstructionDef('SdvmInstCallClosureUInt64', opcode = 0x3120C, type = SdvmTypeUInt64, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call uint64 returning procedure')
SdvmInstCallClosurePointer = sdvmInstructionDef('SdvmInstCallClosurePointer', opcode = 0x3140C, type = SdvmTypePointer, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call pointer returning procedure')
SdvmInstCallClosureProcedureHandle = sdvmInstructionDef('SdvmInstCallClosureProcedureHandle', opcode = 0x3160C, type = SdvmTypeProcedureHandle, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call procedure handle returning procedure')
SdvmInstCallClosureGCPointer = sdvmInstructionDef('SdvmInstCallClosureGCPointer', opcode = 0x3180C, type = SdvmTypeGCPointer, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call fat pointer')
SdvmInstCallClosureFloat32 = sdvmInstructionDef('SdvmInstCallClosureFloat32', opcode = 0x31A0C, type = SdvmTypeFloat32, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call float32')
SdvmInstCallClosureFloat64 = sdvmInstructionDef('SdvmInstCallClosureFloat64', opcode = 0x31C0C, type = SdvmTypeFloat64, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call float64')
SdvmInstCallClosureFloatVector128 = sdvmInstructionDef('SdvmInstCallClosureFloatVector128', opcode = 0x3260C, type = SdvmTypeFloatVector128, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call float vector')
SdvmInstCallClosureIntegerVector128 = sdvmInstructionDef('SdvmInstCallClosureIntegerVector128', opcode = 0x3280C, type = SdvmTypeIntegerVector128, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call integer vector')
SdvmInstCallClosureFloatVector256 = sdvmInstructionDef('SdvmInstCallClosureFloatVector256', opcode = 0x32A0C, type = SdvmTypeFloatVector256, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call float vector')
SdvmInstCallClosureIntegerVector256 = sdvmInstructionDef('SdvmInstCallClosureIntegerVector256', opcode = 0x32C0C, type = SdvmTypeIntegerVector256, arg0Type = SdvmTypeGCPointer, arg1Type = SdvmTypeVoid, description = 'Call integer vector')
